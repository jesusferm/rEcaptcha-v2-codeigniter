		<footer class="footer">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<p class="text-center">
							Copyright @2019 | Designed by <a href="https://linuxitos.com/">LuNuXiToS</a>
						</p>
					</div>
				</div>
			</div>
		...
		<script>
			window.jQuery || document.write('<script src="<?= base_url();?>assets/vendor/jquery/jquery-3.4.1.min.js"><\/script>')
		</script>
